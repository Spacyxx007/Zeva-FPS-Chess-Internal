...
namespace Offsets
{
	constexpr int32 GObjects          = 0x044525E8;
	constexpr int32 AppendString      = 0x00EAD050;
	constexpr int32 GNames            = 0x0443A040;
	constexpr int32 GWorld            = 0x0458BB50;
	constexpr int32 ProcessEvent      = 0x01082DD0;
